...
public class MainConfigs : ConfigBase
{
    ...
    public string TimeDisplayFormat { get; set; } = "tt h:mm:ss";
    ...
    public string NormalMissCountsColor { get; set; } = Constants.Constants.COLOR_WHITE;

    [ConfigCommentZh("音符/红心遗漏计数的文本颜色")]
    [ConfigCommentEn("Accuracy text color of collectable missed count")]
    public string CollectibleMissCountsColor { get; set; } = Constants.Constants.COLOR_WHITE;

    [ConfigCommentZh("Great 计数的文本颜色")]
    [ConfigCommentEn("Accuracy text color of great count")]
    public string GreatCountsColor { get; set; } = Constants.Constants.COLOR_WHITE;
    ...
    public string StatsGapLowerColor { get; set; } = Constants.Constants.COLOR_STATS_GAP_AHEAD;
    ...
    public string StatsGapHigherColor { get; set; } = Constants.Constants.COLOR_STATS_GAP_BEHIND;

    [ConfigCommentZh("当分数超过历史最高分时的分数差值文本颜色")]
    [ConfigCommentEn("Score gap text color when higher than personal best")]
    public string ScoreGapAheadColor { get; set; } = Constants.Constants.COLOR_SCORE_GAP_AHEAD;

    [ConfigCommentZh("当分数低于历史最高分时的分数差值文本颜色")]
    [ConfigCommentEn("Score gap text color when lower than personal best")]
    public string ScoreGapBehindColor { get; set; } = Constants.Constants.COLOR_SCORE_GAP_BEHIND;

    [ConfigCommentZh("当准确率超过历史最高准确率时的准确率差值文本颜色")]
    [ConfigCommentEn("Accuracy gap text color when higher than personal best")]
    public string AccuracyGapAheadColor { get; set; } = Constants.Constants.COLOR_ACCURACY_GAP_AHEAD;

    [ConfigCommentZh("当准确率低于历史最高准确率时的准确率差值文本颜色")]
    [ConfigCommentEn("Accuracy gap text color when lower than personal best")]
    public string AccuracyGapBehindColor { get; set; } = Constants.Constants.COLOR_ACCURACY_GAP_BEHIND;
    ...
    public string TextAllPerfect { get; set; } = Constants.Constants.TEXT_ALL_PERFECT;
    ...
    public string TextTruePerfect { get; set; } = Constants.Constants.TEXT_TRUE_PERFECT;
